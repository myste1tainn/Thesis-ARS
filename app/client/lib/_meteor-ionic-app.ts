...
import {provide, Type, Provider, IterableDiffers, Component, PLATFORM_DIRECTIVES, enableProdMode, PLATFORM_PIPES} from '@angular/core';
...
export function MeteorIonicApp(args:any) {
    return function(cls) {
        ...
        Meteor.startup(function() {
            ...
            //                        { useValue: [VectorToVectorPipe], multi: true }));
