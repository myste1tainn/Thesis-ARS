...
//   { path: 'dog', component: ControlPanelPage }
// ];
...
class MyApp extends MeteorComponent {
    ...
    private rootPage:any = ControlPanelPage;
    ...
    ngOnInit():void {
        ...
        this.pages = [
            ...
            {icon: "settings", title: "control-panel.title", component: ControlPanelPage, rootPage: true},
        ];
